...
def submit_js(url, js, form_details):
...
def xss_vulnerability_testing(url):
    ...
    for one_form in all_forms:
        ...
        response = submit_js(url, script, form_details)
...
if __name__ == "__main__":
    ...
    #URL of Google XSS game
    url = "https://xss-game.appspot.com/level1/frame"
    print(xss_vulnerability_testing(url))
